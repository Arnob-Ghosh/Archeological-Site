...
@section('title', 'Expensive Amount Details')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i>Expensive Details</strong></h5>
                        </div>
                        <div class="card-body">
                            <form action="" method="POST" id="addForm" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label" >Expensive Amount </label>
                                        <input type="number" class="form-control" name="expensive_amount" id="expensive_amount">
                                ...
                                <tbody id="tbody">
                                    @foreach ( $expensiveAmounts as $key => $expensiveAmount )
                                        <tr>
                                            ...
                                            <td>{{ $expensiveAmount->amount }}</td>
                                            <td>{{ $expensiveAmount->created_at }}</td>
                                            <td>
        ...
        $(document).on('click', '.editIcon', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $("#edit_expensive_amount").val(res.amount);
