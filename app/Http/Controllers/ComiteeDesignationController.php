...
class ComiteeDesignationController extends Controller
{
    ...
    public function edit_view()
    {
        ...
        return view('backend\bankUser\comitee_des_edit');
    }
    ...
    public function designation_list(Request $request)
    {
        ...
        {
            $designations=NawabganjSubComitee::where([['form',$request->year1],['to_year',$request->year2]])->get();
            return response()->json([
                'status' => 200,
                'data'=>$designations
        ...
        {
            $designations=DoharSubComitee::where([['form',$request->year1],['to_year',$request->year2]])->get();
        ...
        {
            $designations=CentralComitee::where([['form',$request->year1],['to_year',$request->year2]])->get();
            return response()->json([
                'status' => 200,
                'data'=>$designations
