...
@section('title', 'AMIGO - Feature Phones')
@section('head')
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2" id="page-content">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Feature Phone</li>
            </ol>
        </div><!-- End .container -->
                    ...
                    <div class="owl-carousel owl-loaded owl-carousel-brand brands">
                            ...
                            <ul class="nav nav-pills justify-content-center" role="tablist">
                                <li class="nav-item brand-name">
                                    ...
                                    <a class="all-product  " href="javascript:void(0)" class="brand-sort">
                                        <h3 aria-selected=" true" id="all-product" style="font-size: 2.6rem!important;font-weight:700!important">All </h3>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="item brand-name" >
                            <a href="javascript:void(0)" class="brand-sort" data-value="{{ $brand->id }}">
                                <h3 aria-selected="true" class="text-center" style="font-size: 2.6rem!important;font-weight:700!important">{{ $brand->brand_name }} </h3>
                            </a>
                        </div>
                        @endforeach
