        ...
        <div class="row">
          	<div class="col-lg-12">
	              ...
	              <div class="card-body">
                	...
                	<a href="{{route('slider.create.view')}}"><button type="button" class="btn btn-primary">Add Exibition</button></a>
													...
													@foreach($sliders as $item)
                                                     <tr>
														...
														@endif
														 ...
														 <td>
															<a class="btn btn-info" href="{{route('slider.edit.view',$item->id)}}">Edit</a>
															<a class="btn btn-danger" href="{{route('slider.destroy',$item->id)}}" id="delete">Delate</a>
														 </td>
