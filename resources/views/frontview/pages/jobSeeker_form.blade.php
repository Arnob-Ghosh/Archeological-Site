        ...
        <div class="container">
          ...
          <div class="row mt-5">
            ...
            <div class="col-lg-4">
              <div class="info">
                <div>
                    <img src="{{ asset('frontview/img/job-seeker.jpg') }}" alt="" class="" width="420px" height="582px">
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
                <div class="row">
                    ...
                    <form action="{{ route('search.job.status') }}" method="GET" class="d-flex">
                        <div class="col-md-3">
                            <input type="number" class="form-control" name="job_id" id="job_id" placeholder="Enter your Job ID">
                            {{-- <button type="button" class="btn btn-danger">Job Status</button> --}}
                        </div>
                        <div class="col-md-2 ms-2">
                            <button type="submit" class="btn btn-danger">Job Status</button>
                        </div>
                    </form>
    ...
    <script>
        ...
        $(document).on('click', '.add_jobSeeker_btn', function(e) {
            ...
            $.ajax({
                ...
                method: 'post',
                data: {name:name, email:email, phone:phone, father_name:father_name, mother_name:mother_name, district:district,
                    thana:thana, union:union, village:village, present_address:present_address, permanent_address:permanent_address,
