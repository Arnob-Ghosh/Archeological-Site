    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url('/smart-phone') }}">Smart Phone</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="product-details product-details-centered">
                                ...
                                <figure class="product-main-image">
                                    {{-- <a id="variant-zoom"
                                        href="{{asset($item->smart_phone[0]->over_view_image_large)}}" class="MagicZoom"
                                        data-options="zoomPosition: inner"><img id="product-zoom"
                                            src="{{ asset($item->smart_phone[0]->over_view_image) }}"
                                            alt="product image" /></a> --}}
                                    ...
                                    <img id="product-zoom" src="{{ asset($item->smart_phone[0]->over_view_image) }}"
                                        data-zoom-image="{{asset($item->smart_phone[0]->over_view_image_large)}}"
                                        alt="product image">
                                    {{-- {{ asset($item->smart_phone[0]->over_view_image) }} --}}
                            ...
                            <div class="details-filter-row details-row-size">
                                ...
                                <div class=" product-nav product-nav-thumbs  item-hover-variant-image"
                                    ...
                                    <a href=" #" class="active" id="ab-{{ $i }}">
                                        <img src="{{ asset($image->front_image) }}" alt="product desc"
                ...
                <div class="product-details-tab">
                    <ul class="nav nav-pills justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="product-desc-link" data-toggle="tab" href="#product-desc-tab"
                                role="tab" aria-controls="product-desc-tab" aria-selected="true">Specification</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="product-shipping-link" data-toggle="tab"
                                ...
                                aria-selected="false">In The Box</a>
                        </li>
                        {{-- <li class="nav-item">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="product-desc-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        $res;
                                        // echo $length
                                        // foreach ($phone_details->smart_phone_description as $value) {
                                        // $res=array_search(54,$value);
                                        // }
                                        // echo $res
                                        @endphp
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td rowspan="{{$length}}">
                                                    <h6>{!! $category->specificationCategory_name !!}</h6>
                                                </td>

                                                <td>
                                                    @foreach ($descriptions as $description)
                                                    <h3 class="mb-3">{{$description->feature_name }} </h3>
                                                ...
                                                <td>
                                                    @foreach ($descriptions as $description)
                                                    <h3 class="mb-3">{{ $description->description }} </h3>
                        ...
                        <div class="tab-pane fade" id="product-shipping-tab" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                {{-- <img src="{{ asset($box_image) }}" class="img-fluid" alt="Responsive image"> --}}
                            </div><!-- End .product-desc-content -->
                        </div><!-- .End .tab-pane -->
...
// alert(id);
// if ($.fn.DataTable.isDataTable("#description")) {
//         $("#description").DataTable().destroy();
//     }
...
//         // responsive: true,
//         ajax: {
//             url: "/feature-phone/get-description/"+id,
//             dataSrc: "data",
//         },
