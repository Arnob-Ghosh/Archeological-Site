...
@section('title', 'NoticeBoard & Vision')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i>NoticeBoard & Vision</strong></h5>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tbody id="tbody">
                                    @foreach ( $noticeBoards as $key => $noticesBoard )
                                        <tr>
                                            <th scope="row">{{ ++$key}}</th>
                                            <td>
                                                @if ( !is_null($noticesBoard->image) )
                                                    <img src="{{ asset('images/news/' . $noticesBoard->image ) }}" alt="" width="50" height="50" class="img-fluid">
                                                @else
                                                    N/A
                                                @endif
                                            </td>
                                            <td>{{ $noticesBoard->title }}</td>
                                            <td>{{ $noticesBoard->long_desc }}</td>
                                            <td>{{ $noticesBoard->role }}</td>
                                            <td>
                                                @if( $noticesBoard->status == 1 )
                                                    <span class="badge bg-primary">Active</span>
                                                @elseif( $noticesBoard->status == 0 )
                                                    <span class="badge bg-danger">Inactive</span>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="" id="{{ $noticesBoard->id }}" class="editIcon" data-bs-toggle="modal"
                                                ...
                                                <a href="" id="{{ $noticesBoard->id }}"  class="deleteIcon" >
...
@include('backend.mission_and_noticeboard.edit_modal')
@endsection
