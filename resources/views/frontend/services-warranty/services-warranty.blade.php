...
@section('title', 'AMIGO - Service Warranty Policy')
@section('head')
...
<main class="main">
    <div class="page-header text-center" style="background-image: url('frontend/assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Service Warranty Policy </h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Services Warranty Policy</li>
            </ol>
        </div><!-- End .container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center description">
                    @foreach ($services_warranty as $item)
                    {!!$item->description !!}
                    @endforeach
                </div>
            </div>
